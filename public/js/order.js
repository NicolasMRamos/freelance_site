...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const resultBox = document.getElementById("order-result");
    ...
    form?.addEventListener("submit", async (e) => {
      ...
      const res = await fetch('/action_dispatcher.php?action=create_order', {
        method: "POST",
        headers: {
...
document.addEventListener("DOMContentLoaded", () => {
  const form = document.getElementById("formcorder");
  const resultBox = document.getElementById("corder-result");
    ...
    form?.addEventListener("submit", async (e) => {
      ...
      const formData = new FormData(form);
      const res = await fetch('/action_dispatcher.php?action=create_corder', {
        method: "POST",
        headers: {
          "X-Requested-With": "XMLHttpRequest"
        },
